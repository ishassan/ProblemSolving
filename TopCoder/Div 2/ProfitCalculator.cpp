//TC SRM 154-D2-1	Points= 180 of 250  Time = 25 m
#include <stdio.h>
#include <stdlib.h>
#include <ctype.h>
#include <string.h>
...
int percent(vector <string> items)
{
	...
	for(int i=0; i<items.size(); i++){
		...
		sub1 = items[i].substr(0,6);
		sub2 = items[i].substr(7,13);

		price += atof(sub1.c_str());
		cost += atof(sub2.c_str());
