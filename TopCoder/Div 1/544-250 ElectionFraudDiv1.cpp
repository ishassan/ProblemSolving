...
public:
    ...
    int getMinX(int per, int total){
        int x = (2*total*per - total + 199)/200;
        return max(x,0);
    }
    ...
    int MinimumVoters(vector <int> percentages) {
        repe(t,1,1000000){
            ...
            rep(i,sz(percentages)){
                mn += getMinX(percentages[i],t);
                mx += getMinX(percentages[i]+1,t)-1;
            }
            if(mn <= t && mx >= t) return t;
        }
        return -1;
	}
};
...
int main() {
    ...
    {
    // ----- test 8 -----
    int t0[] = {2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2,2};
	...
	{
	// ----- test 0 -----
	int t0[] = {3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3,3};
			p0.assign(t0, t0 + sizeof(t0) / sizeof(t0[0]));
